...
var AnchorDialog = {
	init : function(ed) {
		...
		if (elm.src != '')
		{
			flag_img = true; //agregado: si el elemento tiene src puede ser una imagen, pongo la bandera en true		
		}
	...
	update : function() {
		if (flag_img != true) //agregado: si es una imagen no hago nada
		{
			var ed = this.editor;
